...
file_name = '/project/expeditions/jfagh/data/era_int_1979/surface/vars.nc';

current_var = 'var59';
current_var_name = 'Convective available potential energy';
current_var_short = 'con_pot_energy';
