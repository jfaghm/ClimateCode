function allMIC = parRowMIC( A, B, msg )
%PARROWMIC Computes MIC between rows of input matrices used when called within PARFOR
%
...
% --> Msg - a string prefix to save temporary files needed by MIC
% 
...
TEMP_FILE_NAME = strcat('ABTemp',msg,'.csv');
SAVE_NAME = 'AB';
